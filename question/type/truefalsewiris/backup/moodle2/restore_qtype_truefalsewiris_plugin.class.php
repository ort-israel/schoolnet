...
class restore_qtype_truefalsewiris_plugin extends restore_qtype_truefalse_plugin{
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'truefalse';
        $xml_name = 'qtype_wq_truefalsewiris';
        
        $elepath = $this->get_pathfor('/truefalse'); // we used get_recommended_name() so this works
        $xml_path = '/question_categories/question_category/questions/question/plugin_qtype_truefalsewiris_question/question_xml';
