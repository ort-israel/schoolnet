...
$string['addingtruefalsewiris'] = 'S\'està afegint una pregunta de verdader/fals - Matemàtiques i Ciències per WIRIS';
$string['truefalsewirissummary'] = 'Igual que la pregunta estàndard de Vertader/Fals, però es poden crear enunciats i retroalimentacions múltiples inserint variables amb números, fórmules o gràfiques. També es pot definir dinàmicament la Resposta correcta.';
$string['truefalsewirisoverrideanswer_identifier_help'] = 'Si es defineix, aquest valor anul·la el camp posterior Resposta correcta. Escriviu a la pestanya Variables un algorisme per posar aquesta variable a "cert" o "fals".';
$string['truefalsewirisoverrideanswer'] = '';
$string['truefalsewirisoverrideanswer_identifier'] = 'Variable de la resposta correcta';;
$string['truefalsewiris_algorithm'] = 'Algorisme';
$string['truefalsewiris_correct_answer_variable'] = 'Variable de la resposta correcta';
$string['truefalsewiris_feedback_wrong_response'] = 'Retroacció per la resposta incorrecta';
