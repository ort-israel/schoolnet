...
class restore_qtype_multianswerwiris_plugin extends restore_qtype_multianswer_plugin {
    ...
    protected function define_question_plugin_structure() {
        ...
        // Add own qtype stuff
        $elename = 'multianswer';
        $xml_name = 'qtype_wq_multianswerwiris';
        
        $elepath = $this->get_pathfor('/multianswer');
        $xml_path = '/question_categories/question_category/questions/question/plugin_qtype_multianswerwiris_question/question_xml';
