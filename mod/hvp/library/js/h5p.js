...
H5P.init = function (target) {
  ...
  var $containers = H5P.jQuery('.h5p-content:not(.h5p-initialized)', target).each(function () {
	...
	/* Lea 2016/07 - Add dir-ltr|rtl to h5p-content div, based on iframe parent document directionality.
         * Taken from https://github.com/h5p/h5p-php-library/pull/23/files*/
