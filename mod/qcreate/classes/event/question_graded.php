...
/**
 * The mod_qcreate question graded event.
 *
 * @package    mod_qcreate
...
/**
 * The mod_qcreate question graded event class.
 *
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class question_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestiongraded', 'mod_qcreate');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' graded the question with id '" . $this->other['questionid'] . "' " .
