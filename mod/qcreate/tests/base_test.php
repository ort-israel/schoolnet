...
/**
 * Base class for unit tests for mod_qcreate.
 *
 * @package    mod_qcreate
 * @category   phpunit
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_qcreate_base_testcase extends advanced_testcase {
    ...
    /** @var stdClass $course New course created to hold the qcreate activities */
    ...
    protected function create_instance($params=array()) {
        ...
        return new testable_qcreate($context, $cm, $this->course);
    }
 ...
 * and add utility methods.
 */
class testable_qcreate extends qcreate {
