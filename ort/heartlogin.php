...
$sectionid   = required_param('section', PARAM_INT); // section id
...
if (isloggedin()){ // take the user to the section in the course id, accroding to the parameters sent from the refferer
    ...
    redirect('http://www.lev.ort.org.il/login.html#courseid='.$courseid.'&amp;section='.$sectionid);// Lea 2015/08 - &amp; needed in order to prevent &sect from becoming §
}
